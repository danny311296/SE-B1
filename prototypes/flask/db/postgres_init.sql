...
insert into properties(title, locality, type, description, bedrooms, bathrooms, patio, address, city, pincode, cost, area) values('Beautiful Blue House','MurugeshPalya','Buy','A beautiful house in bangalore region with brilliant interior design',1,2,1,'12 S R Layout','Bangalore',560017,120300,3020);
